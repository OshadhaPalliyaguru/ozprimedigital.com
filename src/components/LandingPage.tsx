    ...
    return (
        <div className="relative w-full overflow-hidden min-h-screen">
            ...
            <header className="relative min-h-screen flex flex-col justify-center items-center px-4 pt-20">
                {/* Background Elements */}
                <div className="absolute inset-0 z-0 bg-grid-pattern bg-[size:4rem_4rem] opacity-[0.07]"></div>
                <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,rgba(244,213,37,0.08)_0%,transparent_60%)]"></div>
                ...
                <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="font-display font-black text-6xl md:text-8xl lg:text-9xl leading-[0.9] tracking-tighter">
                        <PhysicsItem id="hero-title-1" className="mb-2">
                            <span className="block text-white">WHERE LOGIC</span>
                        </PhysicsItem>
                        <PhysicsItem id="hero-title-2">
                            <span className="block text-gold-gradient">MEETS MAGIC</span>
                        </PhysicsItem>
                    </div>

                    <PhysicsItem id="hero-desc">
                        <p className="font-body text-gray-400 text-lg md:text-xl max-w-2xl leading-relaxed">
                    ...
                    <div className="pt-8">
                        <PhysicsItem id="hero-cta">
                            <button
                                ...
                                className="group relative flex items-center gap-3 bg-transparent border border-primary/50 text-primary font-display font-bold text-lg px-8 py-4 rounded-lg overflow-hidden transition-all hover:border-primary hover:bg-primary/10 animate-pulse-glow cursor-pointer"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <PhysicsItem id="service-card-1" className="h-full">
                                <div className="group relative bg-surface-dark border border-white/10 rounded-2xl p-8 overflow-hidden hover:border-border-gold transition-colors duration-300 h-full">
                                    ...
                                    <div className="relative z-10 h-full flex flex-col justify-end">
                                        <div className="mb-auto p-2 bg-white/5 w-fit rounded-lg mb-8">
                                            <span className="material-symbols-outlined text-primary text-3xl">architecture</span>
                                        </div>
                                        <h3 className="font-display text-2xl font-bold text-white mb-2">Web Architecture</h3>
                        ...
                        <div className="md:row-span-2">
                            <PhysicsItem id="service-card-2" className="h-full">
                                <div className="group relative bg-surface-dark border border-white/10 rounded-2xl p-8 overflow-hidden hover:border-border-gold transition-colors duration-300 flex flex-col h-full">
                                    ...
                                    <h3 className="font-display text-2xl font-bold text-white mb-2">Brand Alchemy</h3>
                        ...
                        <PhysicsItem id="service-card-3">
                            <div className="group relative bg-surface-dark border border-white/10 rounded-2xl p-8 overflow-hidden hover:border-border-gold transition-colors duration-300 h-full">
                                <div className="flex flex-col h-full justify-between">
                                    <div className="p-2 bg-white/5 w-fit rounded-lg">
                                        <span className="material-symbols-outlined text-primary text-3xl">terminal</span>
                                    </div>
                                    <div>
                                        <h3 className="font-display text-xl font-bold text-white mb-1">Full-Stack Dev</h3>
                        ...
                        <PhysicsItem id="service-card-4">
                            <div className="group relative bg-surface-dark border border-white/10 rounded-2xl p-8 overflow-hidden hover:border-border-gold transition-colors duration-300 h-full">
                                <div className="flex flex-col h-full justify-between">
                                    ...
                                    <div>
                                        <h3 className="font-display text-xl font-bold text-white mb-1">Growth Hacking</h3>
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                        ...
                        <PhysicsItem id="pricing-1">
                            <div className="glass-panel rounded-2xl p-8 flex flex-col gap-6 hover:bg-white/10 transition-colors">
                                <div>
                        ...
                        <PhysicsItem id="pricing-2">
                            <div className="glass-panel relative rounded-2xl p-8 flex flex-col gap-6 transform md:-translate-y-4 md:scale-105 border-border-gold shadow-[0_0_40px_rgba(244,213,37,0.1)]">
            ...
            <footer className="bg-black pt-20 pb-10 border-t border-white/10 overflow-hidden relative">
                ...
                <PhysicsItem id="footer-massive">
                    <div className="w-full flex justify-center mt-10 select-none pointer-events-none opacity-20">
